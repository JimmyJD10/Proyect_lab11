    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('contacts.store') }}" enctype="multipart/form-data">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-6">
                    <label for="company" class="block text-md font-medium leading-6 text-gray-900">Empresa</label>
                    <div class="mt-2">
                        <input type="text" name="company" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" value="{{ old('company') }}">
                ...
                <div class="sm:col-span-6">
                    <label for="photo" class="block text-md font-medium leading-6 text-gray-900">Foto de Perfil</label>
                    <div class="mt-2">
                        <input type="file" name="photo" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
